...
If public automated collection cannot proceed, use `manual-products-template.csv` with user-supplied public fields and record the manual selection in `source-report.md`.
